...
def run_single_experiment(c, r, I, m, b):
    ...
    profit_y_multi=expected_profit_norm(multi_y, m_1,m_2, b, r, c)
    ...
    profit_multi_uni = uniform_expected_profit(multi_y, b, r, c)
    ...
    return {
        ...
        'y_star_norm':y_star_norm,'profit_star_norm':profit_star_norm,'profit_y_multi':profit_y_multi,'profit_y1_norm':profit_y1_norm,
        'profit_y2_norm':profit_y2_norm,'profit_y3_norm':profit_y3_norm,
        'y_star_uni':y_star_uni,'profit_star_uni':profit_star_uni,
        'profit_multi_uni':profit_multi_uni,
