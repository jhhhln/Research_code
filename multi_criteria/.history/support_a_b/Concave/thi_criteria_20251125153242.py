...
def check_feasibility(rho, Z1_star, Z2_star, Z3_star,c,r,I,m,a,b):
    def violation(y):
        Z1_val=Z1_y(y,I,m,c,r,a,b)
        Z2_val=Z2_y(y,I,m,c,r,a,b)
        Z3_val=Z3_y(y,I,m,c,r,a,b)
        return max(0, rho * Z1_star - Z1_val, Z2_val - Z2_star / rho, rho * Z3_star - Z3_val)
    result = minimize_scalar(violation, bounds=(a, b), method='bounded')
    return result.fun <= 1e-3,result.x

def find_rho_star_and_y(c, r, I, m, a,b):
    Z1,y_opt_Z1=compute_Z1_values(I, m, c, r,a, b)
    Z2,y_opt_Z2=compute_Z2_values(I, m, c, r,a, b)
    Z3,y_opt_Z3=compute_Z3_values(I, m, c, r,a,b)
    rho_min, rho_max = 0, 1
    tolerance = 1e-3
    ...
    while rho_max - rho_min > tolerance:
        ...
        is_feasible, y = check_feasibility(rho_mid, Z1, Z2, Z3, c, r, I, m,a, b)
