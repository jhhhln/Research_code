...
def generate_pareto_frontier(I, m, c, r, b, num_points=20, filename="pareto_results.csv"):
    """
    生成帕累托前沿并保存详细结果到CSV文件
    :param num_points: 前沿上的点数
    :param filename: CSV文件名
    :return: (results_df, pareto_points, Z1_star, Z3_star)
    """
    # 计算理想点
    Z1_star, y_opt_Z1 = compute_Z1_values(I, m, c, r, b)
    Z3_star, y_opt_Z3 = compute_Z3_values(I, m, c, r, b)
