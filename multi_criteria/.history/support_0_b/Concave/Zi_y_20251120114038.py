...
from support_a_b.Concave.R_star_concave import optimize_s
import numpy as np
...
def Z2_y(y,I,m,c,r,b):
    _,R=optimize_s(I, m, c, r, b, y, lambda_val=1)
    return R
...
def Z3_y(y,I,m,c,r,b):
    ...
    while lambda_max - lambda_min > tolerance:
        ...
        s_opt_mid, value = optimize_s(I, m, c, r, b, y, lambda_val=lambda_mid)
        if value <= 0:
