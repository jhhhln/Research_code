...
from lipstiz.Lipstiz import optimize_s,optimize_y
import numpy as np
...
def Z2_y(y,I,m,c,r,b):
    _,R=optimize_s(I, m, c, r, b, y, lambda_val=1,s_min=0,s_max=b,num_iterations=30)
    return R
...
def Z3_y(y, I, m, c, r, b):
    ...
    while lambda_max - lambda_min > tolerance:
        ...
        s_opt_mid, value = optimize_s(I, m, c, r, b, y, lambda_val=lambda_mid, s_min=0, s_max=b, num_iterations=30)
