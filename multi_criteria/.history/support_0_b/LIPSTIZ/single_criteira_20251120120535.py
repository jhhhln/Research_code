import numpy as np
import pandas as pd
from l import optimize_y,optimize_s
from lipstiz.Zi_y import Z1_y,Z2_y,Z3_y
...
def compute_Z1_values(I, m, c, r, b):
    y_opt_Z1,Z1=optimize_y(I, m, c, r, b, lambda_val=0, y_min=0, y_max=b, s_min=0, s_max=b, lipo_iters=30)
    Z1=-Z1
    return Z1,y_opt_Z1

def compute_Z2_values(I, m, c, r, b):
    y_opt_Z2,Z2=optimize_y(I, m, c, r, b, lambda_val=1, y_min=0, y_max=b, s_min=0, s_max=b, lipo_iters=30)
    return Z2,y_opt_Z2
...
def compute_Z3_values(I, m, c, r, b):
    ...
    while lambda_max - lambda_min > epsilon:
        ...
        y_opt_mid, g_opt_mid = optimize_y(I, m, c, r, b, lambda_val=lambda_mid, y_min=0, y_max=b, s_min=0, s_max=b, lipo_iters=30)
    ...
    y_opt_Z3,_=optimize_y(I, m, c, r, b, lambda_val=Z3, y_min=0, y_max=b, s_min=0, s_max=b, lipo_iters=30)
