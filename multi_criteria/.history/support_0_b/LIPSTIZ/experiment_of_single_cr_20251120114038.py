...
from support_a_b.Concave.Zi_y import Z1_y, Z2_y, Z3_y
from support_a_b.Concave.single_criteria import compute_Z1_values, compute_Z2_values, compute_Z3_values
from support_a_b.Concave.R_star_concave import optimize_y
...
def run_single_experiment(c, r, I, m, b):
    ...
    profit_x1_norm= expected_profit_norm(x1, m_1,m_2, b, r, c)
    profit_x2_norm= expected_profit_norm(x2, m_1,m_2, b, r, c)
    profit_x3_norm= expected_profit_norm(x3, m_1,m_2, b, r, c)
    ...
    profit_x1_uni= uniform_expected_profit(x1, b, r, c)
    profit_x2_uni= uniform_expected_profit(x2, b, r, c)
    profit_x3_uni= uniform_expected_profit(x3, b, r, c)
    ...
    return {
        ...
        'x1':x1,'Z_x1':Z_x1,'profit_x1_norm':profit_x1_norm,'profit_x1_uni':profit_x1_uni,
        'x2':x2,'Z_x2':Z_x2,'profit_x2_norm':profit_x2_norm,'profit_x2_uni':profit_x2_uni,
        'x3':x3,'Z_x3':Z_x3,'profit_x3_norm':profit_x3_norm,'profit_x3_uni':profit_x3_uni,
    }
