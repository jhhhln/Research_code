...
def run_single_experiment(c, r, I, m,a, b):
    """单个参数组合的实验任务（可并行运行）"""
    try:
        rho, multi_y = find_rho_star_and_y(c, r, I, m,a, b)
    ...
    # 多目标
    Z1_multi = Z1_y(multi_y, I, m, c, r, a,b)
    Z2_multi = Z2_y(multi_y, I, m, c, r, a,b)
    Z3_multi = Z3_y(multi_y, I, m, c, r,a, b)
...
def run_numerical_experiment_multi(mu_values, c, r, I, a,b, max_workers=None):
    ...
    with ProcessPoolExecutor(max_workers=max_workers) as executor:
        ...
        for mu in mu_values:
            m = np.array([1, mu])       
            futures.append(
                executor.submit(run_single_experiment, c, r, I, m, a,b)
            )
