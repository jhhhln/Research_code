...
plt.plot(df['sigma/'], df['Z1_y2_over_Z1_star'], marker='o',
         label=r'$\frac{Z_1(y_2,\mathcal{F})}{Z_1^*(\mathcal{F})}$',color='#1f77b4')
plt.plot(df['sigma/'], df['Z3_y2_over_Z3_star'], marker='s',
...
plt.tight_layout()
plt.savefig('cross1_I2_2.pdf', format='pdf', bbox_inches='tight')
plt.show()
...
plt.plot(df['sigma/'], df['Z2_star_over_Z2_y1'], marker='o',
         label=r'$\frac{Z_2^*(\mathcal{F})}{Z_2(y_1,\mathcal{F})}$',color='#1f77b4')
plt.plot(df['sigma/'], df['Z3_y1_over_Z3_star'], marker='s',
...
plt.tight_layout()
plt.savefig('cross1_I2_1.pdf', format='pdf', bbox_inches='tight')
plt.show()
...
# === 4. 绘制图像 ===
plt.figure(figsize=(6, 4.5))
plt.plot(df['sigma/'], df['Z1_y3_over_Z1_star'], marker='o',
         label=r'$\frac{Z_1(y_3,\mathcal{F})}{Z_1^*(\mathcal{F})}$',color='#1f77b4')
plt.plot(df['sigma/'], df['Z2_star_over_Z2_y3'], marker='s',
...
plt.grid(False)
plt.tight_layout()
plt.savefig('cross1_I2_3.pdf', format='pdf', bbox_inches='tight')
plt.show()